...
public class ElectricLocomotive extends Locomotive {
    ...
    public ElectricLocomotive(EmptyData emptyData, ManufacturerInfo manufInfo, double tractiveForce) {
        super(emptyData, manufInfo, tractiveForce, EngineType.ELECTRIC);
    }
}
